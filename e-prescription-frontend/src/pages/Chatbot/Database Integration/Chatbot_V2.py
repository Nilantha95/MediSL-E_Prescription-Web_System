...
SERVICE_ACCOUNT_KEY_PATH = '../API_keys/medisl-ed07f-firebase-adminsdk-fbsvc-d2764a2e96.json' # Example: Update with your actual new file name
...
if __name__ == "__main__":
    ...
    if not os.path.exists('../Dataset/sympthoms_diseases.csv'):
    ...
    upload_symptoms_diseases('../Dataset/sympthoms_diseases.csv')
