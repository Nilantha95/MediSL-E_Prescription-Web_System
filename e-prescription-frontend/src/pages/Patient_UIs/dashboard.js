...
          <Link to="/dashboard" style={{ ...sidebarLinkStyle, ...sidebarLinkActiveStyle }}>Patient Dashboard</Link>
...
              <thead>
                <tr>
                  <th style={recentPrescriptionsTableHeaderStyle}>PRESCRIPTION ID</th>
                  <th style={recentPrescriptionsTableHeaderStyle}>ISSUED DATE</th>
                  <th style={recentPrescriptionsTableHeaderStyle}>DOCTOR</th>
                  <th style={recentPrescriptionsTableHeaderStyle}>PHARMACY</th>
                </tr>
              </thead>
              <tbody>
...
        subtitle="Ask about your medications & tips"
        handleNewUserMessage={(msg) => {
          // Send message to your backend chatbot and return a response
          console.log(msg); // Placeholder for your chatbot integration
        }}
      />
